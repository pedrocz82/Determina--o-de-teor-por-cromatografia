function developModel(){
    ...
    //Get input arrays
  var x_values = [document.getElementById('x_values1').value,
  document.getElementById('x_values2').value,
  ...
  document.getElementById('y_values2').value,
  ...
  document.getElementById('y_values5').value
    ...
    document.getElementById('regressionEquation').innerHTML = "<b>Equação da reta: </b> "+String(regressor['slope'])+"*x + "+String(regressor['intercept']);
    
    var concentracaofinal = (sinal - regressor['intercept'])/regressor['slope'];
    document.getElementById('concentracaofinal').innerHTML = "<b>Concentração (mg/L): </b>"+concentracaofinal;
